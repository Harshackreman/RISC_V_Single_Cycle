...
REM
REM Generated by Vivado on Wed Jun 10 14:27:47 +0530 2026
...
echo "xvlog --incr --relax -prj tb_ALU_BLOCK_vlog.prj"
call xvlog  --incr --relax -prj tb_ALU_BLOCK_vlog.prj -log xvlog.log
